...
export default function AdminAuditLogsPage() {
    ...
    }, [selectedAction, selectedPeriod, searchQuery, dateFrom, dateTo, pagination.per_page]);

    useEffect(() => {
        fetchActionTypes();
        fetchPeriods();
    }, [fetchActionTypes, fetchPeriods]);
    ...
    const handlePerPageChange = (value: string) => {
        setPagination(prev => ({ ...prev, per_page: parseInt(value) }));
        fetchLogs(1);
    };
