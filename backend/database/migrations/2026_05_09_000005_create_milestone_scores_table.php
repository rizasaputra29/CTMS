...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('milestone_scores', function (Blueprint $table) {
            ...
            $table->index(['created_at'], 'idx_milestone_scores_created_at');
            $table->index(['group_id', 'created_at'], 'idx_milestone_scores_group_created');
        });
    }
    ...
    {
        Schema::dropIfExists('milestone_scores');
    }
};
