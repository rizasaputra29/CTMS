  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className={cn(
          "flex w-full min-h-10 items-center gap-1.5 rounded-md border bg-grey-25 px-3 py-2 text-sm transition-colors",
          open
      ...
      {open && (
        <div className="absolute left-0 right-0 top-full z-50 mt-1 rounded-md border border-grey-100 bg-card p-1 shadow-medium">
          {options.map((option) => {
