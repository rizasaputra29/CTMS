      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-gray-50/50 hover:bg-gray-50/50">
            ...
            <TableHead className="w-16 pr-4 text-center">Action</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
                            ...
                            <div className="space-y-2 text-sm">
                              ...
                              {period.ta_start && (
                                <div className="flex justify-between">
                                  ...
                                  <span className="font-medium text-gray-900">
                                    {formatDate(period.ta_start)} —{" "}
                                    {formatDate(period.ta_end)}
                                  </span>
                                </div>
                              )}
                            </div>
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium text-gray-900">
                                  ...
                                  {period.max_group_size} orang
                                </span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-600">
                                  Max Dosen Pembimbing
                                </span>
                                <span className="font-medium text-gray-900">
